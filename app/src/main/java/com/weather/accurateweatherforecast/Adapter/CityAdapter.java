   ...
   public  CityAdapter(Context context,DailyResult dailyResult ){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
      //  Picasso.get().load(new StringBuilder("https://openweathermap.org/img/wn/").
               // append(dailyResult.daily.get(position).weather.get(0).getIcon()).append(".png").toString()).into(holder.img_weathercity);
        holder.txt_date_timecity.setText(new StringBuilder(Common.converttounixdaily( dailyResult.daily.get(position).getDt())));
        //holder.txt_descriptioncity.setText(new StringBuilder(dailyResult.daily.get(position).weather.get(0).getDescription()));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemViewcity) {
          ...
          //  txt_descriptioncity = (TextView) itemViewcity.findViewById(R.id.txt_descriptioncity);
