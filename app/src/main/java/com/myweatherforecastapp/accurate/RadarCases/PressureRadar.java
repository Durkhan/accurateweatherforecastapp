...
public class PressureRadar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pressure_radar);
        ...
        backdrawer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(PressureRadar.this, MainActivity.class);
        ...
        GradientDrawable gradientDrawable=new GradientDrawable(
               ...
               new int[]{
                       ContextCompat.getColor(this,R.color.colorpressure1),
                       ContextCompat.getColor(this,R.color.colorpressure2),
                       ContextCompat.getColor(this,R.color.colorpressure3),
                       ContextCompat.getColor(this,R.color.colorpressure4),
                       ContextCompat.getColor(this,R.color.colorpressure5),


        }
        );
        findViewById(R.id.backgroundpressure).setBackground(gradientDrawable);
    ...
    private void spineradapter() {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(radar_cases ==0){
                    Intent back = new Intent(PressureRadar.this, RadarActivity.class);
                    back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(back);

                }
                else if(radar_cases ==2){
                    Intent back = new Intent(PressureRadar.this, CloudsRadar.class);
                    back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(back);
                    ...
                    Intent back = new Intent(PressureRadar.this,WindspeedRadar.class);
                    back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(back);
                    ...
                    Intent back = new Intent(PressureRadar.this, PrecipitationRadar.class);
                    back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(back);
                ...
                if (location != null) {
                    ...
                    supportMapFragment.getMapAsync(new OnMapReadyCallback() {
                        ...
                        public void onMapReady(GoogleMap googleMap) {
                            ...
                            googleMap.addTileOverlay(new TileOverlayOptions().tileProvider(createTileProvider("pressure_new")).visible(true));
                        }
                    });
