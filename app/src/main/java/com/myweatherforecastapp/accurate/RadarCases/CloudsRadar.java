...
public class CloudsRadar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clouds_radar);
        ...
        backdrawer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(CloudsRadar.this, MainActivity.class);
        ...
        GradientDrawable gradientDrawable=new GradientDrawable(
                ...
                new int[]{
                        ContextCompat.getColor(this,R.color.colorclouds1),
                        ContextCompat.getColor(this,R.color.colorclouds2),
                        ContextCompat.getColor(this,R.color.colorclouds3),
                        ContextCompat.getColor(this,R.color.colorclouds4)
                }
        );
        findViewById(R.id.backgroundclouds).setBackground(gradientDrawable);
    ...
    private void spineradapter() {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(radar_cases ==0){
                    Intent back = new Intent(CloudsRadar.this, RadarActivity.class);
                    back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(back);

                }
                else if(radar_cases ==1){
                    Intent back = new Intent(CloudsRadar.this, PressureRadar.class);
                    back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(back);
                    ...
                    Intent back = new Intent(CloudsRadar.this,WindspeedRadar.class);
                    back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(back);
                    ...
                    Intent back = new Intent(CloudsRadar.this, PrecipitationRadar.class);
                    back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(back);
                ...
                if (location != null) {
                    ...
                    supportMapFragment.getMapAsync(new OnMapReadyCallback() {
                        ...
                        public void onMapReady(GoogleMap googleMap) {
                            ...
                            googleMap.addTileOverlay(new TileOverlayOptions().tileProvider(createTileProvider("clouds_new")).visible(true));
                        }
                    });
