...
public class WeeklyAdabter  extends RecyclerView.Adapter<WeeklyAdabter.MYViewHolder> {
    Context context;
    DailyResult dailyResult;
    public  WeeklyAdabter(Context context,DailyResult dailyResult ){
        this.context=context;
        this.dailyResult=dailyResult;
    }
    @NonNull
    @Override
    public WeeklyAdabter.MYViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View convertview= LayoutInflater.from(context).inflate(R.layout.sevendaydetails_item,parent,false);
        return new MYViewHolder(convertview);
    }

    @Override
    public void onBindViewHolder(@NonNull WeeklyAdabter.MYViewHolder holder, int position) {
